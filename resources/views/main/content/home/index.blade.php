...
<div class="row">
  <div class="col-lg-8">
    ...
    @include('main.content.home.partials.trending')

    @include('main.content.home.partials.popular')

    @include('main.content.home.partials.recent')
  ...
  <div class="col-lg-4 col-md-6 col-sm-8">
    <div class="product__sidebar">
      ...
      @include('main.content.home.partials.sidebar.view')

      @include('main.content.home.partials.sidebar.comment')
